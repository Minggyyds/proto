...
const (
	Good_GetArticles_FullMethodName = "/Good/GetArticles"
)
...
func (c *goodClient) GetArticles(ctx context.Context, in *GetArticlesReq, opts ...grpc.CallOption) (*GetArticlesRes, error) {
	out := new(GetArticlesRes)
	err := c.cc.Invoke(ctx, Good_GetArticles_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGoodServer) GetArticles(context.Context, *GetArticlesReq) (*GetArticlesRes, error) {
...
func _Good_GetArticles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetArticlesReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoodServer).GetArticles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Good_GetArticles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodServer).GetArticles(ctx, req.(*GetArticlesReq))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Good_GetArticles_Handler,
		},
	},
